<template>
  <div>
    <div class="sidebar">
      ...
      <router-link to="/editlokasi" class="btn1" href="#">EditLokasi</router-link>
      <router-link to="/manage" class="btn3" href="#">AturJarak</router-link>
    ...
    <div class="content">
      <div class="main">
        ...
        <div class="heading">
          <h1 class="head">TRAFFIC <span> PAGE</span></h1>
